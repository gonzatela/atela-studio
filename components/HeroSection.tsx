    ...
    <section className="relative min-h-screen pt-32 pb-20 md:pt-44 md:pb-32 flex flex-col justify-center overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 relative z-10 w-full">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-indigo-500/30 bg-indigo-500/10 backdrop-blur-md mb-8"
        >
        ...
        {/* Action Buttons & Quick Work Links */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
