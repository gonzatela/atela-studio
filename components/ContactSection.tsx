...
import { Send, CheckCircle2, Mail, Globe, Sparkles, MessageSquare, ArrowUpRight } from 'lucide-react';
...
export const ContactSection: React.FC<ContactSectionProps> = ({ initialEstimate }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setSubmitted(true);
    setTimeout(() => {
      // Keep submitted feedback active
    }, 500);
  };
    ...
    <section id="contact" className="py-24 md:py-36 relative z-10 bg-zinc-950/90 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16">
          {/* Left Column - Studio Info & Direct Channels */}
